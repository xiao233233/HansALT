            ...
            set
            {
                ...
                try
                {
                    if (_PortValue == IOValue.OFF)
                        pictureBox1.Image = global::UserControl_XDS.Properties.Resources.指示灯_红色;
                    else if (_PortValue == IOValue.ON)
                        pictureBox1.Image = global::UserControl_XDS.Properties.Resources.指示灯_绿色;
                    else
                        pictureBox1.Image = global::UserControl_XDS.Properties.Resources.指示灯_灰色;
                }
                catch (Exception e)
                { }
            }
